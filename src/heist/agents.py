...
DEFAULT_AGENTS: dict[str, AgentSpec] = {
    ...
    "claude-opus-4.8-xhigh": AgentSpec(
    ...
    "claude-opus-4.7-high": AgentSpec(
    ...
    "openrouter-gemini-3.5-flash": _opencode_agent(
